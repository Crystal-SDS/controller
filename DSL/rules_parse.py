...
# condition_list = Forward()
    ...
    limit_value = number
    condition = Group(services_options("services_options") + operand("operand") + limit_value("limit_value"))
    ...
    rule_parse = for_tenant + tenant_id("tenant_id") + when + condition_list("condition_list") + do + action("action")
